...
@property (strong,nonatomic) PSTableTestViewController *tableViewController;
...
- (BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.restorationIdentifier = @"rootWindow";
    //colors
    if ([self.window respondsToSelector:@selector(setTintColor:)]) {
        self.window.tintColor = [UIColor redColor];
    }
    
    self.tableViewController = [[PSTableTestViewController alloc] init];
    self.tableViewController.restorationIdentifier = @"pasLab";
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:_tableViewController];
    navigationController.restorationIdentifier = @"mainNavController";
